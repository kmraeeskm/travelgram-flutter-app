...
class ReviewSheetProfile extends StatefulWidget {
  final String postID;
  final String uId;

  const ReviewSheetProfile({
    super.key,
  ...
  @override
  State<ReviewSheetProfile> createState() => _ReviewSheetProfileState();
}

class _ReviewSheetProfileState extends State<ReviewSheetProfile> {
